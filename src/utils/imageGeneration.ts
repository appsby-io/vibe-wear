...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  comic: "catchy vintage manga comic style Single-panel comic illustration that would look good on a poster: Draw it in a 1960s Saturday-morning adventure style, similar to Pokemon or Digimon, dynamic composition, expressive character poses – thick uniform black ink outlines, flat sun-faded primary colours (sky-blue, warm ochre, golden yellow, cream highlights), subtle halftone texture, and dynamic motion lines. Shot at a slightly low angle so the characters break the frame edges. No modern 3-D shading, gradients, or photographic detail – keep it strictly flat-colour",
