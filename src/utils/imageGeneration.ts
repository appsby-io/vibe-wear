...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  comic: "manga comic style Single-panel vintage comic illustration:Draw it in a 1960s Saturday-morning adventure-comic style, similar to Pokemon or Digimon, dynamic composition, expressive character poses, no photorealism – thick uniform black ink outlines, flat sun-faded primary colours (sky-blue, warm ochre, golden yellow, cream highlights), subtle halftone texture, and dynamic motion lines. Shot at a slightly low, mid-distance angle so the characters break the frame edges. No modern 3-D shading, gradients, or photographic detail – keep it strictly flat-colour comic art.looks motif look catchy on a plain white background.",
