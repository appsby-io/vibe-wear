...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  comic: "Single-panel vintage comic illustration:Draw it in a 1960s Saturday-morning adventure-comic style – thick uniform black ink outlines, flat sun-faded primary colours (sky-blue, warm ochre, golden yellow, cream highlights), subtle halftone texture, and dynamic motion lines. Shot at a slightly low, mid-distance angle so the characters break the frame edges. No modern 3-D shading, gradients, or photographic detail – keep it strictly flat-colour comic art.",
