...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  "cartoon-avatar": "2D cartoon character avatar with exaggerated features, clean white #ffffff background, large expressive eyes, clean bold outlines, bright saturated colors, glossy highlights. Modern emoji/avatar style similar to Apple Memoji, friendly and approachable design",
