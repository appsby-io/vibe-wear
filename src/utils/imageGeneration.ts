...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  comic: "Manga comic style illustration, clean line art with bold outlines, flat bright colors, cel shading, simple backgrounds, high contrast, expressive character poses, in the style of classic 1990s Japanese manga similar to Pokémon or Digimon, dynamic composition, cute and friendly aesthetic, no photorealism, comic panel style.",
  ...
  minimalist: "reate in clean minimalist style with sophisticated simplicity. Simple geometric lines, monochromatic or very limited color palette (black, white, one accent color), plenty of white space, modern sans-serif typography, essential elements only. Focus on clean lines, geometric shapes, and sophisticated restraint.",
  ...
  grunge: "Grunge rock poster style with distressed textures, rough edges, high contrast black and white with selective color accents. Raw, edgy aesthetic with worn textures and bold typography elements.",
